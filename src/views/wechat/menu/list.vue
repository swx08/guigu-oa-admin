<template>
    <div class="app-container">
      ...
      <!-- 工具条 -->
      <div class="tools-div">
        <el-button type="success" class="btn-add" size="mini" @click="add">添 加</el-button>
        <el-button type="success" class="btn-add" size="mini" @click="syncMenu" >同步菜单</el-button>
        <el-button type="danger" class="btn-add" size="mini" @click="removeMenu">删除菜单</el-button>
      </div>
      ...
      <el-table
        ...
        <el-table-column label="操作" width="170" align="center">
          <template slot-scope="scope">
            <el-button v-if="scope.row.parentId > 0" type="warning" size="mini" @click="edit(scope.row.id)">修改</el-button>
            <el-button v-if="scope.row.parentId > 0" type="danger" size="mini" @click="removeDataById(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
